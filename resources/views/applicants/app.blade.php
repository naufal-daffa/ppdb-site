    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="pt-4 overflow-y-auto">
            <ul class="nav flex-column px-2">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('applicants.documents.index') }}">
                        <i class="fas fa-list-check"></i>
                        Dokumen
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('applicants.certificates.index') }}">
                        <i class="fas fa-folder-open"></i>
                        Sertifikat
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('applicants.choices.index') }}">
